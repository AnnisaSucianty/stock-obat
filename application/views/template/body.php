...
<head>
	...
	<link rel="icon" href="<?php echo base_url('assets/images/ikonapotek.ico') ?>" type="image/ico" />
		...
		<div class="main_container">
			...
			<footer>
				<div class="pull-right">
					<a href="https://aposyafamedika.com/" title="apoteksyafamedika.com" target="_blank">apoteksyafamedika.com</a> | Apotek Syafa Medika | </a> <?php echo $footer; ?>
				</div>
				<div class="clearfix"></div>
			</footer>
			<!-- /Footer Content -->
